<?php 
/**
 * Offers an opportunity for the entrar to subscribe to updates to their
 * entry.
 * 
 * PHP Version 7.5.3
 * 
...
<?php if (!empty($new_case_id)) { ?>
    ...
    <p>Please keep this with your records. You will need it if you want 
        to talk to us about it.</p>
    <h2>Do you want to receive updates?</h2>
    <form action="/umpire/subscribe/" method=post><fieldset>
        <legend>Yes, please subscribe!</legend>
        <p>Note: subscribing lets us read your email address.</p>
        <p><label><input type=checkbox name=agree/> I have read and agree</label> 
            to the <a href="../../subscribe/terms/">terms and conditions</a>.</p>
    ...
    <form action="/umpire/" method=get><fieldset><legend>No, thanks!</legend>
        <p><label><input type=submit 
            value="I'm fine with not receiving updates."/></label></p>
    </fieldset></form>
<?php } ?>
<p>Where to next? Would you like to return to 
    <a href="../../../">the home page</a>, 
    or <a href="../../../forms/">submit a new case</a>? 
    Or maybe you want to view our 
    <a href="../../../view/statistics/">statistics</a>?</p>
</body>
</html>
