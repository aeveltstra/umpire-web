...
<meta name="description" value="Save this info: it will be shown 
    only once."
/>
...
<body>
    ...
    <p>We created some access keys for you. You will be asked for these 
        when you log in. If you lose them, you have to reset them. Our
        operatives CANNOT retrieve them, and CANNOT send them to you.
    </p>
    <p>Note: our operatives will NEVER ask for your key or secret pass 
        phrase. They may ask for your email address.
    </p>
